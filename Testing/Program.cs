...
//Func<BitBoard7x7, float> evaluation = Heuristics.BasicEval;
...
FendoEngine engine = new FendoEngine(SearchType.AlphaBeta, new BitBoard7x7());


// 2. Suche starten
Console.WriteLine("Suche nach dem besten Zug...");
//(float score, Turn best_turn) = search.Evaluate(3);
Turn best_turn = engine.BestTurn(4);
